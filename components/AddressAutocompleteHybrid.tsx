// components/AddressAutocompleteHybrid.tsx
// Híbrido: Edge function para autocompletado, Google Maps solo para visualización
...
export default function AddressAutocompleteHybrid({
  value,
  onChange,
  ...
  const handleSuggestionClick = async (suggestion: any) => {
    ...
    try {
      ...
      console.log('📦 Place details structure:', JSON.stringify(placeDetails, null, 2));
