                ...
                <div className="px-4 py-6 sm:px-0">
                    <div className="border-4 border-dashed border-gray-200 rounded-lg h-96 flex items-center justify-center">
                        <div className="text-center">
                            <h2 className="text-2xl font-semibold text-gray-900">Panel de Repartidor</h2>
                            <p className="mt-2 text-gray-600">Bienvenido a tu panel de control.</p>
                            <p className="mt-4 text-sm text-gray-500">Aquí podrás ver tus entregas y gestionar tu estado.</p>
                        </div>
                    </div>
                </div>
            </main>
