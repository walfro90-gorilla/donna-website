                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead className="bg-gray-50 dark:bg-gray-800">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white">Rating</th>
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900">
                                    {loading ? (
                                        ...
                                        <tr>
                                            <td colSpan={5} className="text-center py-4 text-gray-500 dark:text-gray-400">No se encontraron restaurantes</td>
                                        </tr>
                                    ) : (
                                            ...
                                            <tr key={restaurant.id}>
                                                <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                                    <div className="flex items-center">
                                                        ...
                                                        <div className="ml-4">
                                                            ...
                                                            <div className="text-gray-500 dark:text-gray-400">{restaurant.cuisine_type || 'Sin categoría'}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-gray-400">
                                                    <div className="text-gray-900 dark:text-white">{restaurant.users?.email}</div>
                                                    <div className="text-gray-500 dark:text-gray-400">{restaurant.phone || restaurant.users?.phone}</div>
                                                </td>
                                                ...
                                                <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-gray-400">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="ml-1 text-gray-900 dark:text-white">{restaurant.average_rating?.toFixed(1) || 'N/A'}</span>
                                                    </div>
                                                </td>
