...
export const metadata: Metadata = {
  title: 'Dashboard Restaurante - Doña Repartos',
  description: 'Panel de control para restaurantes - Gestiona tu menú, pedidos y configuración.',
};
...
export default async function RestaurantPage() {
  ...
  // Fetch restaurant details for progress calculation
  ...
  // Fetch user preferences for onboarding modal
  ...
  const onboardingStatus = calculateRestaurantProgress(restaurant);
  const showWelcomeModal = !preferences?.has_seen_restaurant_welcome;

  return (
    <div className="min-h-screen bg-gray-50">
      <OnboardingModal
        isOpen={showWelcomeModal}
        onClose={markRestaurantWelcomeAsSeen}
        role="restaurant"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
              ...
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                    <svg className="w-8 h-8 text-[#e4007c] mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                    <span className="text-sm font-medium text-gray-900">Nuevo Plato</span>
                  </button>
          ...
          {/* Right Column: Onboarding & Recent Orders */}
              ...
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      <p className="text-sm font-medium text-gray-900">#001234</p>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      <p className="text-sm font-medium text-gray-900">#001233</p>
                      <p className="text-xs text-gray-500">Hace 12 min</p>
                    </div>
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">$18.75</p>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      <p className="text-sm font-medium text-gray-900">#001232</p>
                      <p className="text-xs text-gray-500">Hace 18 min</p>
                    </div>
                    <div className="text-right">
